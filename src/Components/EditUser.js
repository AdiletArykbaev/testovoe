        ...
        <Form onSubmit={onSubmit}>
            <FormGroup>
                <div>
                    ...
                    <Input  value={selectedUser.name} onChange={(e)=>{
                        onChange(e)
                    }}  type="text" placeholder="ФИО" name="name">
                ...
                <div>
                    <Label>Id</Label>
                    <Input value={selectedUser.id}  onChange={(e)=>{
                        onChange(e)
                ...
                <div>
                    ...
                    <Input value={selectedUser.birthday} onChange={(e)=>{
                        onChange(e)
                    }}   type="date" placeholder="ДАТА РОЖДЕНИЯ" name="birthday">
